...
{{text = "أوامر الحماية" ,data="Amr_"..data.sender_user_id.."_1"},{text = "إعدادات المجموعة",data="Amr_"..data.sender_user_id.."_2"}},
{{text = "فتح/قفل",data="Amr_"..data.sender_user_id.."_3"},{text ="اخرى",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦.',url="t.me/xXStrem"}},
}
}
...
{{text = ' 🇮🇶 ┇ 𝘹𝘹𝘴𝘵𝘳𝘦?? 𝘴𝘰𝘶𝘳𝘤𝘦 ',url="t.me/xXStrem"}},
}
...
local Text = "*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦\n\n*[ 🇮🇶 ┇  𝘴𝘵𝘳𝘦𝘮 𝘤𝘩𝘢𝘯𝘯𝘦𝘭](http://t.me/xXStrem)*\n\n*[ 🇮🇶 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/xXStrem)*\n\n*[ 🇮🇶 ┇  𝘹𝘹𝘴𝘵𝘳𝘦𝘮 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/xXStrem)*\n\n*[ 🇮🇶 ┇  ʙᴏᴛ 𝘹𝘹𝘴𝘵𝘳𝘦𝘮](http://t.me/xXStrem)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦 ',url="t.me/xXStrem"}
