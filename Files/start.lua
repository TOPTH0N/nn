...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " احمد"
SudosS = {874820580}
...
type = 'inline',
data = {
{{text = ' 🇮🇶 ┇ 𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦',url="t.me/xXStrem1"}},
}
}
...
{{text = ' 🇮🇶 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "احمد"),data="delnamebot"}},
...
{{text = ' 🇮🇶 ┇ 𝘹𝘹𝘴𝘵𝘳𝘦?? 𝘴𝘰𝘶𝘳𝘤𝘦 ',url="t.me/xXStrem1"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/xXStrem1&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  🇮🇶 ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "احمد"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "احمد"),"اني لقميل "..(redis:get(bot_id..":namebot") or "احمد"),(redis:get(bot_id..":namebot") or "احمد").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "احمد") then
...
local UserId_Info = bot.searchPublicChat("xXStrem")
if UserId_Info.id then
...
local Text = "*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦\n\n*[ 🇮🇶 ┇  𝘴𝘵𝘳𝘦𝘮 𝘤𝘩𝘢𝘯𝘯𝘦𝘭](http://t.me/xXStrem1)*\n\n*[ 🇮🇶 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/xXStrem1)*\n\n*[ 🇮🇶 ┇  𝘹𝘹𝘴𝘵𝘳𝘦𝘮 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/xXStrem)*\n\n*[ 🇮🇶 ┇  ʙᴏᴛ 𝘹𝘹𝘴𝘵𝘳𝘦𝘮](http://t.me/xXStrem1)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝘹𝘹𝘴𝘵𝘳𝘦𝘮 𝘴𝘰𝘶𝘳𝘤𝘦 ',url="t.me/xXStrem1"}
