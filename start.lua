...
Sudos = {sudoid,5413631898,5413631898}
Sudo_Id = 5413631898
function Bot(msg)  
local idbot = false  
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 yousef TeAm >](t.me/zqqqzq1) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/zqqqzq1)'
...
- تم انشاء الصانع مقدم من قناة ( @zqqqzq1 ) مجاناً 
...
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @xXStrem .
- للتواصل مع مطور البوت  : @zqqqzq .*
